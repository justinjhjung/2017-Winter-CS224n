...
class NERModel(Model):
    ...
    def fit(self, sess, saver, train_examples_raw, dev_set_raw):
        ...
        # Read the doc for utils.get_minibatches to find out how to use it.
            ...
            # My code should run, but due to train_examples not in a form of including features, labels, This code cannot run.
            '''minibatch_list = get_minibatches(train_examples,self.config.batch_size)
            for [features, labels] in minibatch_list:
                loss = train_on_batch(self, sess, features, labels)
                print(loss)'''
